...
from decortication import analyzer, fat, variables
...
def main():
	...
	gROOT.SetBatch()
        ...
        ## Input:
#	in_files = ["file:/home/ag1378/cmslink/second/CMSSW_9_4_14/src/Analyzers/FatjetAnalyzer/test/tuple__Fall17_pt0_090414.root"]
	
	## Arguments:
	a = variables.arguments()
	args = a.args
	
	tuples = ["file:/home/ag1378/cmslink/second/CMSSW_9_4_14/src/Analyzers/FatjetAnalyzer/test/tuple__Fall17_pt0_090414.root"]
	# if not tuples:
